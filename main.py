...
parser.add_argument('--label_percentage', default=1.0, type=float,
                    help='Percentage of labeled data to use for training (e.g., 0.01 for 1%)')
...
configs = Configs()
configs.label_percentage = args.label_percentage
